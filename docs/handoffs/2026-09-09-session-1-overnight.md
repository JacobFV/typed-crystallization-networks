# Handoff — 2026-09-09, session 1: overnight substrate and capability pass

*Archived session record. Point-in-time as of 2026-09-09, superseded in places by
session 2 and by `research/FINDINGS.md` §38–44 — in particular the language
capability is **0.9986**, not the 1.000 stated below, and it reproduces only on
the pre-audit stream (§39, §43). Kept unedited as the record of what was known
then.* The living entry point is [`HANDOFF.md`](../../HANDOFF.md).
