...
|---|---|---|---|---|
| mixed | 0.0163 ms | 0.000112 ms | **146×** | max abs error 0.0 vs `sin(float(a!=b)+x)` on 4 cases |
| language | 4.061 ms | 0.000496 ms | **8,187×** | `common.balanced` agrees with the program and the label on 12/12 held-out episodes |
