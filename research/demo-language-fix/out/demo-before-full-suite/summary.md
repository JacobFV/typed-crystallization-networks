...
structure    unseen pool 3.25/4 (seen 3.25/4), interpreter candidate chosen fr… best constant 2.25/4; the recorded scaffold measures 1.95-2.03 and cannot exceed 2.00        PASS
depth        exact frozen program d1 4.00, d2 4.00, d3 4.00, d4 4.00, d6 4.00,… best constant d1 2.00, d2 2.25, d3 2.50, d4 2.75, d6 2.25, d8 2.00                           PASS
...
positional   1,024 positions over a 3,072-value observation with 3 caller node… 17 structural symbols shared against 109 per-position and 257 inlined at 32 positions, at 0… PASS
...
language     raised ValueError: training examples required                                                                                                                   FAIL
```
...
- **structure** — held-out Boolean gate families, interpreter candidate not supplied
  - measured: unseen pool 3.25/4 (seen 3.25/4), interpreter candidate chosen from 17: True
  - baseline: best constant 2.25/4; the recorded scaffold measures 1.95-2.03 and cannot exceed 2.00
...
- **depth** — trained at depths 1-2 only, scored at depths never trained on
  ...
  - baseline: best constant d1 2.00, d2 2.25, d3 2.50, d4 2.75, d6 2.25, d8 2.00
...
- **positional** — one frozen module at every position of a wide observation
  - measured: 1,024 positions over a 3,072-value observation with 3 caller nodes, exact apply correct (8 s)
...
- **edge** — a learned two-position operator over raw pixels, offset searched
  ...
  - baseline: unique among 48 staged programs in 0.5 s; undecomposed 4.9e10 programs (7.6 years projected); constant predictor 0.844
...
- **language** — 
  - measured: raised ValueError: training examples required
  - baseline: 
  - evidence: see traceback
