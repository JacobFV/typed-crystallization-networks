...
The connectivity guard probes the unregularized task loss throughout, as on
branch `perturbation-selection`; nothing here varies it. The gate's own progress
readings use that same unregularized loss.
"""
